...
class ProfileDetailScreen extends StatefulWidget {
  ...
  const ProfileDetailScreen({required this.person});

  @override
  State<ProfileDetailScreen> createState() =>
      ProfileDetailScreenState();
}

class ProfileDetailScreenState
                        ...
                        ..._recommendations
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // ── Star Rating (1-5) ──
                              // Show as a compact row of filled/empty
                              // stars so it's obvious this coach
                              // rated the player 3★, 4★, etc.
                              if (r['rating'] != null) ...[
                                const SizedBox(
                                    height: 4),
                                Row(
